...
| [**deleteUser**](UsersApi.md#deleteUser) | **DELETE** /users/{id} | Delete user by ID |
...
| [**updateUser**](UsersApi.md#updateUser) | **PUT** /users/{id} | Update user by ID |
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    Integer id = 56; // Integer | ID of the user to delete
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    Integer id = 56; // Integer | ID of the user to retrieve
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    Integer id = 56; // Integer | ID of the user to update
    User user = new User(); // User | 
    try {
